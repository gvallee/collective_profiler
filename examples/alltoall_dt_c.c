...
alltoall_test_node_params_t* create_params_sets(rank_set_t* rank_sets){
    ...
    params_sets[0] = (alltoall_test_node_params_t) {.send_type_idx = 0, .recv_type_idx = 0, .sendcount =  16, .recvcount =  16, .rank_set = &rank_sets[0], .repetitions=1};
    params_sets[1] = (alltoall_test_node_params_t) {.send_type_idx = 1, .recv_type_idx = 1, .sendcount =  16, .recvcount =  16, .rank_set = &rank_sets[0], .repetitions=1};
    params_sets[2] = (alltoall_test_node_params_t) {.send_type_idx = 2, .recv_type_idx = 2, .sendcount =  16, .recvcount =  16, .rank_set = &rank_sets[0], .repetitions=1};
    params_sets[3] = (alltoall_test_node_params_t) {.send_type_idx = 3, .recv_type_idx = 3, .sendcount =  16, .recvcount =  16, .rank_set = &rank_sets[0], .repetitions=1};
    return params_sets;
} 
