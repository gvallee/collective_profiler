...
alltoall_test_node_params_t* create_params_sets(rank_set_t* rank_sets){
    ...
    params_sets[2] = (alltoall_test_node_params_t) {.send_type_idx = 2, .recv_type_idx = 2, .sendcount =  16, .recvcount =  16, .rank_set = &rank_sets[2], .repetitions=1};  // fails at this test
...
int main(int argc, char *argv[]) {
    ...
    int param_sets_set_count = 2;  // TO DO - fails at 3 
