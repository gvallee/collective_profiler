...
func extractTimingsFromSeparateTimingFile(file string, callsMaps map[int]maps.CallsDataT, commData map[int]map[int]map[int]float64) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func analyzeTimingsFiles(dir string, files []string, callsMaps map[int]maps.CallsDataT) (map[int]map[int]map[int]float64, map[int]map[int]map[int]float64, error) {
...
func HandleTimingFiles(dir string, callsMaps map[int]maps.CallsDataT) (map[int]map[int]map[int]float64, map[int]map[int]map[int]float64, error) {
